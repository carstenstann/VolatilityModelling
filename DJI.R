...
## fix column names
colnames(RV) <- c("DJI") ##"FTSE100", "Nikkei225", "DAX", "DJI", "CAC40"
colnames(returns) <- c("DJI") ##"FTSE100", "Nikkei225", "DAX", "DJI", "CAC40"
