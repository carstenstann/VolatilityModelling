...
RV.na <- import %>% select(FTSE2.rv) %>% 
  as.xts(order.by = import$DateID) ##FTSE2.rv, N2252.rv,DJI2.rv, FCHI2.rv - SPX2.rv, GDAXI2.rv

returns.na <- import %>% select(FTSE2.r) %>% 
  as.xts(order.by = import$DateID) ## FTSE2.r, N2252.r, GDAXI2.r,DJI2.r, FCHI2.r - SPX2.r, GDAXI2.r
...
## fix column names
colnames(RV) <- c("FTSE100") ##"FTSE100", "Nikkei225", "DAX", "DJI", "CAC40"
colnames(returns) <- c("FTSE100") ##"FTSE100", "Nikkei225", "DAX", "DJI", "CAC40"
